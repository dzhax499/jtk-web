        ...
        <div class="flex justify-between items-center h-24">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="hidden sm:block">
                    <div class="text-[#00008B] font-extrabold text-xl tracking-wide">JTK POLBAN</div>
                    <div class="text-[#00008B] font-medium text-[15px] leading-snug mt-0.5">Jurusan Teknik Komputer<br>dan Informatika</div>
                </div>
            </div>

            <div class="hidden lg:flex items-center space-x-10 xl:space-x-12 h-full">
                ...
                <a href="/berita" class="text-[#00008B] font-bold hover:text-blue-700 transition">Berita</a>
                <a href="/profil-dosen" class="text-[#00008B] font-bold hover:text-blue-700 transition">Profil Dosen</a>
                <a href="/akreditasi" class="text-[#00008B] font-bold hover:text-blue-700 transition">Akreditasi</a>
                <a href="/arsip" class="text-[#00008B] font-bold hover:text-blue-700 transition">Arsip</a>
            </div>
